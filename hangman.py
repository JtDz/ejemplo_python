...
while True:
    ...
    if guess in secretWord:
        ...
        # PISTA PARA QUE ADIVINE
        elif gameIsDone == False and len(secretWord) >= 4 and len(correctLetters) == 2:
            for i in range(len(secretWord)):
                if secretWord[i] != correctLetters[i]:
                    print('HINT: YOU GOT A LETTER! ' + secretWord[i] )
                break
            correctLetters = correctLetters + secretWord[i].upper()
